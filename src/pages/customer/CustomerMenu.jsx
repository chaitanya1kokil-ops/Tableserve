...
// Multicolor Google "G" (inline so it works offline / under strict CSP).
        ...
        <div className="flex items-center gap-4">
          ...
          {restaurant.google_review_url && (
            <a
              ...
              className="group flex flex-shrink-0 items-center gap-2 rounded-full bg-white py-2 pl-2.5 pr-3.5 shadow-lg shadow-black/25 ring-1 ring-black/5 transition hover:-translate-y-0.5 active:scale-95"
            >
              ...
              <span className="flex flex-col leading-none">
                ...
                <span className="mt-1 text-[11px] font-bold text-stone-700">Review us</span>
              </span>
            </a>
          )}
        </div>
...
function BrandPicker({ brands, categories, items, accent, logos, onPick }) {
        ...
        {brands.map((b) => (
          ...
          >
            ...
            <div className="relative flex items-center gap-4">
              {logos?.[b] && (
                <img
                  src={imageUrl(logos[b])}
                  alt=""
                  className="h-16 w-16 flex-shrink-0 rounded-2xl object-cover ring-1 ring-white/25"
                />
              )}
              <div className="min-w-0 flex-1">
